...
# Database
# Use postgresql, default to sqlite for initial testing if no DB_URL provided
...
# Ensure database atomic requests
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'core.pagination.AqarPagination',
    'PAGE_SIZE': 20,
